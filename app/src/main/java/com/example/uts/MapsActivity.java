...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] id,nama,jambuka,telp,gambar;
    int jumData;
...
// Obtain the SupportMapFragment and get notified when the map is ready to be used.
    ...
    {
        String url = "https://gissasw.000webhostapp.com/mimir.php";
                ...
                for (int i = 0; i < jumData; i++) {
                    try {
                        ...
                        mMap.addMarker(new MarkerOptions()
                                .position(latLng[i])
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.outputwater))
                                .title(nama[i]));
                        ...
                        for (int i = 0; i < jumData; i++) {
                            if (marker.getTitle().equals(nama[i])) {
                                if (MarkerD[i]) {
                                    ...
                                    Toast pesan = Toast.makeText(MapsActivity.this, "KLIK FOR DETAILS", Toast.LENGTH_LONG);
